...
/// Реализация AuthServiceProtocol поверх Go-бэкенда.
/// Все запросы идут через APIClient (/auth/register, /auth/login, /auth/telegram, /auth/me).
...
/// Обёртка для трёх состояний поля: "не менять" (nil), "сбросить в null" (.null), "установить значение".
