    ...
    private static func defaultSeed() -> [Item] {
        ...
        return [
            ...
            Item(
                ...
                locationAddress: "Москва, ул. Тестовая, д. 2"
            ),
            Item(
                name: "пиво",
                ...
                locationAddress: "Москва, ул. Тестовая, д. 3"
            ),
            Item(
                name: "лимонад",
                categoryName: "напитки",
                ...
                locationAddress: "Москва, ул. Тестовая, д. 4"
            ),
            Item(
                name: "капибара",
                categoryName: "напитки",
                ...
                locationAddress: "Москва, ул. Тестовая, д. 5"
            ),
            Item(
                name: "водка",
                categoryName: "напитки",
                ...
                locationAddress: "Москва, ул. Тестовая, д. 6"
            )
        ]
    }
}
